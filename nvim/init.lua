...
vim.keymap.set('n', ';', ':')
-- don't want press 3 keys to switch
...
vim.keymap.set('n', '<leader>p', '<cmd>read !xclip -sel c<cr>')
vim.keymap.set('n', '<leader>c', '<cmd>w !xclip -sel c<cr><cr>')
